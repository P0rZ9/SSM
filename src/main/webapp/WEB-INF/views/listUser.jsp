    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        ...
        <c:forEach items="${users}" var="s" varStatus="status">
            <tr>
                ...
                <td><a href="/updateUser?id=${s.id}"><span class="glyphicon glyphicon-edit"></span> </a></td>
                <td><a href="/delUser?id=${s.id}" onclick="return del();"><span class="glyphicon glyphicon-trash"></span> </a></td>
            </tr>
        </c:forEach>
...
<div class="addDIV">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <form method="post" action="/addUser" role="form">
                <table class="addTable">
                    <tr>
                        <td>学号：</td>
                        <td><input type="text" name="user_id" id="user_id" placeholder="请在这里输入学号"></td>
                    </tr>
                    <tr>
                        <td>姓名：</td>
                        <td><input type="text" name="username" id="name" placeholder="请在这里输入名字"></td>
                    </tr>
                    <tr>
                        <td>年龄：</td>
